...
namespace TPV {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductosDataTable : global::System.Data.TypedTableBase<ProductosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductosRow AddProductosRow(string Nombre, decimal Precio, int Cantidad) {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Usuario, string Contrasena, int Admin) {
...
namespace TPV.Database1DataSet1TableAdapters {
    ...
    public partial class ProductosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Productos` WHERE ((`Id` = ?) AND ((? = 1 AND `Nombre` IS NULL) OR (`" +
                "Nombre` = ?)) AND ((? = 1 AND `Precio` IS NULL) OR (`Precio` = ?)) AND ((? = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Productos` (`Nombre`, `Precio`, `Cantidad`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Productos` SET `Nombre` = ?, `Precio` = ?, `Cantidad` = ? WHERE ((`Id` = " +
                "?) AND ((? = 1 AND `Nombre` IS NULL) OR (`Nombre` = ?)) AND ((? = 1 AND `Precio`" +
                " IS NULL) OR (`Precio` = ?)) AND ((? = 1 AND `Cantidad` IS NULL) OR (`Cantidad` " +
                "= ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TPV.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nombre, Precio, Cantidad FROM Productos";
        ...
        public virtual int Fill(Database1DataSet1.ProductosDataTable dataTable) {
        ...
        public virtual Database1DataSet1.ProductosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.ProductosDataTable dataTable = new Database1DataSet1.ProductosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.ProductosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nombre, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<int> Original_Cantidad) {
        ...
        public virtual int Update(string Nombre, global::System.Nullable<decimal> Precio, global::System.Nullable<int> Cantidad, int Original_Id, string Original_Nombre, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<int> Original_Cantidad) {
            if ((Nombre == null)) {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Usuarios` WHERE ((`Id` = ?) AND ((? = 1 AND `Usuario` IS NULL) OR (`" +
                "Usuario` = ?)) AND ((? = 1 AND `Contrasena` IS NULL) OR (`Contrasena` = ?)) AND " +
            ...
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Usuarios` (`Usuario`, `Contrasena`, `Admin`) VALUES (?, ?, ?)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE `Usuarios` SET `Usuario` = ?, `Contrasena` = ?, `Admin` = ? WHERE ((`Id` =" +
                " ?) AND ((? = 1 AND `Usuario` IS NULL) OR (`Usuario` = ?)) AND ((? = 1 AND `Cont" +
                "rasena` IS NULL) OR (`Contrasena` = ?)) AND ((? = 1 AND `Admin` IS NULL) OR (`Ad" +
                "min` = ?)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Usuario, Contrasena, Admin FROM Usuarios";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, string Original_Usuario, string Original_Contrasena, global::System.Nullable<int> Original_Admin) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Usuario, string Contrasena, global::System.Nullable<int> Admin) {
            if ((Usuario == null)) {
                this.Adapter.InsertCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Usuario, string Contrasena, global::System.Nullable<int> Admin, int Original_Id, string Original_Usuario, string Original_Contrasena, global::System.Nullable<int> Original_Admin) {
            if ((Usuario == null)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
